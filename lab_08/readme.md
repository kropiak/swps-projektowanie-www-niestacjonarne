...
5. Do odpytania endpointów oprócz widoków serwowanych przez DRF wykorzystaj również program `Postman` (jeżeli będzie to możliwe) lub polecenie `curl` (Dokumentacja: https://curl.se/docs/manual.html). Możesz również skorzystać z rozszerzenia EchoAPI dla narzędzia Visual Studio Code.
6. Bazując na przykładzie z dokumentacji pod adresem https://www.django-rest-framework.org/tutorial/3-class-based-views/ wykonaj:
   ...
   * dodaj nowy branch o nazwie `lab_8_class_views` i przełącz się na niego,
